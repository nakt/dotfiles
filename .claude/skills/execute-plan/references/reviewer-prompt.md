...
以下はプランの `## 合意事項` 全文の転記です。生成コードがこれらに沿っているかも仕様適合の観点に含めてレビューしてください。ここに「合意事項なし」の旨が書かれている場合 (短縮形プラン) は、この観点を評価対象から外してください。
...
- プラン合意事項との整合性: 上記「プラン合意事項」の各項目が生成コードに反映されているか。当該タスクに関係する項目が反映されていない場合は NEEDS_CHANGES (「合意事項なし」の場合はこの観点をスキップ)
